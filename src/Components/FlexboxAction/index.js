...
const FlexboxAction = ({ updateValues, removeItem, addItem, simulatorData }) => {
            ...
            return (
              <div className={styles.sectionItem} key={index}>
                <div className={styles.title}>
                  ...
                  <FlexboxActionModal title={flexboxActionItemData.title} description={flexboxActionItemData.documentation} />
                </div>
                <div className={styles.options}>
                  <RadioGroup
                    ...
                    onChange={(event) => onChangeOption(flexboxActionItemData.id, event.target.value)}
                  >
                    {flexboxActionItemData.values.map((optionValue, indexValue) => {
                      return <FormControlLabel value={optionValue} control={<Radio color="primary" />} label={optionValue} />;
                    })}
                  </RadioGroup>
                </div>
              </div>
