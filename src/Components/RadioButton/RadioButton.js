...
// as long as it's not disabled
  ...
  render() {
    ...
    const style = horizontal ? {display:'flex', flexWrap: 'wrap'} : {};
    return (
  ...
  getStyles() {
    ...
    return {
      root: {
        ...
        color: disabled ? (disabledColor || '#e1e1e1') : (rootColor || '#999999'),
        borderWidth: 1,
        borderStyle: 'solid',
        borderColor: disabled ? (disabledColor || '#e1e1e1') : (rootColor || '#999999'),
        borderRadius: 1,
        padding: 10,
        marginBottom: horizontal ? 10 : label ? (padding || 16) / 2 : (padding || 16),
      ...
      label: {
        ...
        borderStyle: 'none',
        padding: padding || 8,
        marginBottom: horizontal ? 5 : (padding || 8),
