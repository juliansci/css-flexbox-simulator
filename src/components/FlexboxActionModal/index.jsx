      ...
      {(close) => (
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            <div
              className={styles.globalDescription}
              dangerouslySetInnerHTML={{
                __html: description.globalDescription,
              }}
            />
            <div className={styles.values}>
              {description.valuesDescription.map(
                (valueDescription, indexValue) => {
                  return (
                    <div className={styles.value} key={indexValue}>
                      <div>{valueDescription.id}:</div>
                      <div
                        dangerouslySetInnerHTML={{
                          __html: valueDescription.description,
                        }}
                      />
                    </div>
                  );
